...
router.post('/channels/:id/join', authenticateJWT, async (req, res) => {
  try {
    ...
    res.status(status).json({ error: 'Failed to join channel' });
  }
});
...
router.get('/conversations/:id', authenticateJWT, async (req, res) => {
  try {
    ...
    res.status(status).json({ error: 'Failed to fetch conversation' });
  }
});
...
router.delete('/conversations/:id', 
  ...
  async (req, res) => {
    try {
      ...
      res.status(status).json({ error: 'Failed to delete conversation' });
    }
  }
);
...
router.post('/conversations/:id/participants', authenticateJWT, async (req, res) => {
  try {
    ...
    res.status(status).json({ error: 'Failed to add participants' });
  }
});
