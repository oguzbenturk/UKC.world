        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex-1 space-y-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-duotone-bold-extended text-slate-900">My Schedule</h1>
            ...
            <div className="grid grid-cols-3 gap-3">
              <article className="rounded-2xl border border-slate-200/80 bg-white/95 p-4 text-center shadow-sm">
                ...
                <p className="mt-1 text-2xl font-duotone-bold-extended text-slate-900">{scheduleSummary.totalLessons}</p>
              ...
              <article className="rounded-2xl border border-sky-200/80 bg-sky-50/80 p-4 text-center shadow-sm">
                ...
                <p className="mt-1 text-2xl font-duotone-bold-extended text-sky-700">{scheduleSummary.upcomingCount}</p>
              ...
              <article className="rounded-2xl border border-emerald-200/80 bg-emerald-50/80 p-4 text-center shadow-sm">
                ...
                <p className="mt-1 text-2xl font-duotone-bold-extended text-emerald-700">{scheduleSummary.pastCount}</p>
