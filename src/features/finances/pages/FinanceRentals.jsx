...
/**
 * FinanceRentals - Finance view for rental revenue
 */
const FinanceRentals = () => {
  ...
  const headlineStats = useMemo(() => {
    if (!summaryData) {
      return [
        { key: 'rentals', label: 'Rental Revenue', value: '--', accent: 'orange' },
        { key: 'active', label: 'Active Rentals', value: '--', accent: 'emerald' },
        { key: 'outstanding', label: 'Customer Debt', value: '--', accent: 'amber' },
        { key: 'net', label: 'Net Rental Revenue', value: '--', accent: 'slate' }
      ];
    }
    ...
    <div className="min-h-screen space-y-6 bg-slate-50 p-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <Tag color="orange" className="text-xs font-medium">Rentals</Tag>
            </div>
      ...
      <Card className="rounded-3xl border border-slate-200/70 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-slate-900">Rental Transactions</h3>
          <Button
