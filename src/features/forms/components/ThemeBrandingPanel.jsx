...
const ThemeBrandingPanel = ({ themeConfig, onUpdate, disabled }) => {
  ...
  const handleValuesChange = (changedValues, allValues) => {
    ...
    const newTheme = {
      background: {
        type: allValues.backgroundType,
        color: allValues.backgroundColor,
        gradient: allValues.backgroundGradient,
        image_url: backgroundImageUrl,
        image_fit: allValues.backgroundFit || 'cover',
        overlay_opacity: (allValues.overlayOpacity || 40) / 100,
        overlay_color: allValues.overlayColor,
        blur: allValues.backgroundBlur || 0,
      },
      branding: {
        logo_url: logoUrl,
        company_name: allValues.companyName,
        show_header: allValues.showHeader,
        header_bg_color: allValues.headerBgColor,
        show_footer: allValues.showFooter,
        footer_text: allValues.footerText,
      ...
      content: {
        form_title: allValues.formTitle,
        form_description: allValues.formDescription,
        show_title: allValues.showTitle,
      },
      colors: {
        primary: allValues.primaryColor,
        formBackground: allValues.formBackground,
        formOpacity: allValues.formOpacity,
        formBorderRadius: allValues.formBorderRadius,
        textColor: currentTheme.colors.textColor,
        headerTextColor: currentTheme.colors.headerTextColor,
        titleColor: allValues.titleColor,
      },
    };
    ...
    try {
      ...
      const newTheme = {
        background: {
          ...
          color: allValues.backgroundColor,
          gradient: allValues.backgroundGradient,
          image_url: allValues.backgroundImage,
          image_fit: allValues.backgroundFit || 'cover',
          overlay_opacity: (allValues.overlayOpacity || 40) / 100,
          overlay_color: allValues.overlayColor,
          blur: allValues.backgroundBlur || 0,
