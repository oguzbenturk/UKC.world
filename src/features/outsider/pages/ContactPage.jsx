...
const WHATSAPP_OPTIONS = [
  { label: 'Shop inquiries', value: '+90 539 952 90 28', href: 'https://wa.me/905399529028' },
  { label: 'School inquiries', value: '+90 507 138 91 96', href: 'https://wa.me/905071389196' },
];

const INSTAGRAM_OPTIONS = [
  { label: 'DPC-urla', value: '@dpc_urla', href: 'https://instagram.com/dpc_urla' },
  { label: 'Urla Kite Center', value: '@urlakitecenter', href: 'https://instagram.com/urlakitecenter' },
  { label: 'UKC Shop', value: '@ukc_shop', href: 'https://instagram.com/ukc_shop' },
];
