...
const SECTION_CONFIG = [
  { id: 'kite-packages', key: 'kite', image: '/Images/ukc/kite-header.jpg.png', path: '/experience/kite-packages' },
  { id: 'wing-packages', key: 'wing', image: '/Images/ukc/wing-header.png', path: '/experience/wing-packages' },
  { id: 'downwinders', key: 'downwinders', image: '/Images/ukc/rebel-dlab-header.jpg', path: '/experience/downwinders' },
  { id: 'camps', key: 'camps', image: '/Images/ukc/evo-sls-header.jpg', path: '/experience/camps' },
];
...
const ExperienceLandingPage = () => {
  ...
  const sections = SECTION_CONFIG.map((s) => ({
    id: s.id,
    label: t(`outsider:experience.nav.${s.key}`),
    title: t(`outsider:experience.sections.${s.key}.title`),
    description: t(`outsider:experience.sections.${s.key}.description`),
    buttonText: t(`outsider:experience.sections.${s.key}.cta`),
    image: s.image,
    path: s.path,
  }));
    ...
    <div className="bg-[#0d1511] min-h-screen text-white font-sans selection:bg-yellow-500/30 relative z-0">
      ...
      <div className="py-16 sm:py-20 border-t border-white/5 bg-[#0d1511]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-duotone-bold-extended mb-1 text-white uppercase tracking-tight">{t('outsider:experience.faq.title')}</h2>
