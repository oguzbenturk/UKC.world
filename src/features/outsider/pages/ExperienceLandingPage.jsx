...
const ExperienceLandingPage = () => {
  ...
  return (
    <div className="bg-[#0f1013] min-h-screen text-white font-sans selection:bg-yellow-500/30">
      
      {/* Sticky Navigation */}
      <div className="sticky top-0 z-50 bg-[#0f1013]/80 backdrop-blur-md border-b border-white/5">
      ...
      {/* Explore Footer */}
      <div className="bg-neutral-900 py-12 border-t border-white/5">
