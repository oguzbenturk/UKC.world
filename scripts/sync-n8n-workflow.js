...
const workflowFile = path.join(root, 'kai-optimized.json');

// Parse the workflow (system prompt is already embedded in the jsCode node)
// Only include fields accepted by the n8n PUT /workflows/{id} API
