...
test.describe('12.1 Public Registration', () => {
  ...
  test('Complete 3-step registration and auto-login', async ({ page }) => {
    ...
    // Step 1: Account info â€” Ant Design Form.Item renders #id selectors
    ...
    // Step 2: Profile info â€” all required: country_code, phone, date_of_birth, weight, preferred_currency
    // country_code is an Ant Design Select â€” click and pick first option
    ...
    // date_of_birth â€” DatePicker: click, then type a date
    ...
    // Step 3: Address info â€” all required: address, city, zip_code, country
    ...
    const submitBtn = page.getByRole('button', { name: /Finish/i });
