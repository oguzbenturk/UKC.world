...
await jest.unstable_mockModule('../../../../backend/services/paymentGateways/index.js', () => ({
  __esModule: true,
  getGateway: () => ({ initiateDeposit: initiateDepositMock }),
  supportedGateways: ['iyzico', 'binance_pay']
}));

const { initiateGatewayDeposit } = await import('../../../../backend/services/paymentGatewayService.js');
