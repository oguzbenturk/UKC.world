...
beforeAll(async () => {
  ...
  await jest.unstable_mockModule('../../../../backend/services/notificationDispatcher.js', () => ({
    default: dispatcherMock,
    notificationDispatcher: dispatcherMock
  }));

  await jest.unstable_mockModule('../../../../backend/services/metrics/notificationMetrics.js', () => ({
    default: metricsMock,
  ...
  await jest.isolateModulesAsync(async () => {
    const module = await import('../../../../backend/services/bookingNotificationService.js');
