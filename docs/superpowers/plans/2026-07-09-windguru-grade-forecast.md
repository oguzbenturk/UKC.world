...
- Backend Jest tests live in `tests/unit/backend/<domain>/<name>.test.js` (NOT colocated — jest `roots` is `../tests/unit/backend`), header `/* eslint-env jest */`, and import source via a relative path from that location, e.g. `../../../../backend/services/weather/<file>.js`. Run from repo root via `npm --prefix backend test -- <path-substring>`.
...
- `tests/unit/backend/weather/windguruScraper.test.js`
- `tests/unit/backend/weather/mix.test.js`
- `tests/unit/backend/weather/index.test.js`
- `tests/unit/backend/weather/accuracy.test.js`
...
- Test: `tests/unit/backend/weather/mix.test.js`
...
Create `tests/unit/backend/weather/mix.test.js`:
```js
/* eslint-env jest */
/* global describe, it, expect */
...
```bash
git add backend/services/weather/cardinal.js backend/services/weather/mix.js tests/unit/backend/weather/mix.test.js
...
- Test: `tests/unit/backend/weather/index.test.js` (create)
...
`buildForecast` is a pure function (no network, no db), so the test needs no mocking. Create `tests/unit/backend/weather/index.test.js`:
```js
/* eslint-env jest */
/* global describe, it, expect */
...
```bash
git add backend/services/weather/index.js backend/services/weather/modelOrder.js backend/services/weather/spots.js backend/services/weather/accuracy.js backend/routes/weather.js tests/unit/backend/weather/index.test.js
...
- Test: `tests/unit/backend/weather/accuracy.test.js`
...
Create `tests/unit/backend/weather/accuracy.test.js`:
```js
/* eslint-env jest */
/* global describe, it, expect */
...
```bash
git add backend/services/weather/accuracy.js tests/unit/backend/weather/accuracy.test.js
