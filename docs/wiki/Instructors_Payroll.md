...
- **Rescue boat:** `rescue_boat` 4. ders kategorisi; kaptan-oranı yoksa komisyon 0 (varsayılana DÜŞMEZ). BookingDrawer'da skill-bypass + yolcu sayısı alanı (`discipline_tag === 'rescue_boat'`). Bkz. `project_rescue_boat_service` (in progress).
